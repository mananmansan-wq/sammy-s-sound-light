    ...
    <div className="container mx-auto max-w-4xl">
      ...
      >
        ...
        <p className="text-foreground/70 text-lg leading-relaxed max-w-2xl mx-auto">
          En <span className="text-primary font-semibold">Sonido Sammy</span>  En Corporativo Sammy somos líderes en producción audiovisual, nos especializamos en soluciones integrales para eventos masivos y corporativos. Contamos con tecnología de vanguardia en iluminación, audio profesional y pantallas de última generación, diseñadas para escenarios de alto impacto. Transformamos sus eventos empresariales, conciertos y convenciones en experiencias inolvidables con calidad de nivel superior.
        </p>
